// Workflow state types for Social-CalSticks integration
...
export interface SocialStickWithWorkflow {
  id: string
  topic: string
  content: string
  color: string
...
export interface AttentionFilter {
  ...
  count: number
  icon: string
  filter: (sticks: SocialStickWithWorkflow[]) => SocialStickWithWorkflow[]
}
