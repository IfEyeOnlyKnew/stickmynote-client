...
import { AccountsManager } from "@/components/social/accounts-manager"
import { AdminManager } from "@/components/social/admin-manager"
import {
  Settings,
  Globe,
  Lock,
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex items-center gap-4">
              <Button variant="outline" onClick={() => router.push(`/social/pads/${padId}`)}>
            ...
            <Tabs defaultValue="general" className="w-full">
              ...
              <TabsContent value="general" className="space-y-6 mt-6">
                ...
                <div className="flex justify-end gap-3 pt-4 border-t">
                  ...
                  <Button onClick={handleSave} disabled={!name.trim() || saving} className="social-gradient text-white">
                    {saving ? (
                      <>
