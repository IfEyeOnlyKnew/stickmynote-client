...
import { MobilePadView } from "@/components/social/mobile-pad-view"
...
export default function MobileSocialLayout() {
  ...
  const fetchContent = async () => {
    // Fetch logic similar to main social page
    setLoading(false)
  }
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                onClick={() => router.push("/social/notifications")}
              >
            ...
            {publicPads.length > 0 ? (
              publicPads.map((pad) => (
                <MobilePadView
                  ...
                  onStickView={(id) => router.push(`/social/sticks/${id}`)}
              ...
              <Card className="text-center py-12">
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600 mb-4">Create a public social pad to get started!</p>
                  <Button onClick={() => router.push("/social/hubs")}>
                    <Plus className="h-4 w-4 mr-2" />
                    Create Pad
                  </Button>
                </CardContent>
            ...
            {privatePads.length > 0 ? (
              ...
              <Card className="text-center py-12">
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600 mb-4">Create a private social pad to get started!</p>
                  <Button onClick={() => router.push("/social/hubs")}>
                    <Plus className="h-4 w-4 mr-2" />
                    Create Pad
                  </Button>
      ...
      <div className="fixed bottom-4 right-4 z-50">
        <Button
          ...
          onClick={() => router.push("/social/hubs")}
        >
