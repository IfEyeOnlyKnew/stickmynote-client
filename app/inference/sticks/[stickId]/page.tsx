...
import { ReplyModal } from "@/components/inference/reply-modal"
...
export default function InferenceStickDetailPage() {
        ...
        <div className="container mx-auto px-4 py-4">
          <BreadcrumbNav
            items={[
              ...
              { label: stick.social_pads.name, href: `/inference/pads/${stick.social_pad_id}` },
