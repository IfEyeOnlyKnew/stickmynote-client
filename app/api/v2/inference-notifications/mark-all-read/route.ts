...
// POST /api/v2/inference-notifications/mark-all-read - Mark all inference notifications as read
export async function POST(request: NextRequest) {
  try {
    ...
    await db.query(
      `INSERT INTO inference_notification_reads (user_id, notification_key, last_read_at)
