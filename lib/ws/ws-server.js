...
function createWebSocketServer(server) {
  ...
  server.on("upgrade", (req, socket, head) => {
    ...
    // Node.js v24 creates a ServerResponse for upgrade requests too.
    // Detach it from the socket so Next.js handleRequestImpl can't write
    // HTTP data onto our WebSocket connection ("Invalid frame header").
