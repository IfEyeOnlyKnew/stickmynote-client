...
export function getSecurityHeaders(): SecurityHeaders {
  ...
  const cspDirectives = [
    ...
    "img-src 'self' data: blob: https://*.supabase.co https://vercel.com https://*.vercel.com https://*.vercel-analytics.com https://i.ytimg.com https://img.youtube.com https://i.vimeocdn.com https://*.public.blob.vercel-storage.com https://*.vimeo.com https://*.cloudfront.net https://*.canva.com https://*.imgur.com https://*.googleusercontent.com",
    "media-src 'self' blob: https://*.supabase.co https://www.youtube.com https://player.vimeo.com https://rumble.com https://*.rumble.com https://www.loom.com https://*.loom.com",
