...
export interface VideoTabContentBaseProps {
  readonly videos: VideoItem[]
  readonly videoUrl: string
  readonly addingVideo: boolean
  readonly readOnly?: boolean
  readonly onVideoUrlChange: (url: string) => void
  readonly onAddVideo: () => void
  readonly onDeleteVideo?: (videoId: string) => void
}

export function VideoTabContentBase({
  videos,
  videoUrl,
  addingVideo,
  readOnly = false,
  ...
  onAddVideo,
  onDeleteVideo,
}: Readonly<VideoTabContentBaseProps>) {
