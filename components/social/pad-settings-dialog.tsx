...
export function PadSettingsDialog({ open, onOpenChange, pad, currentUserId, onUpdate }: PadSettingsDialogProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      setSaving(true)
      const response = await fetch(`/api/social-pads/${pad.id}`, {
        method: "PATCH",
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Manage your social pad settings and members</DialogDescription>
          </DialogHeader>
          ...
          <Tabs defaultValue="general" className="w-full">
            ...
            <TabsContent value="members" className="space-y-4 mt-4">
              <div className="text-center py-8">
                ...
                <Button onClick={() => setShowMembersDialog(true)} className="social-gradient text-white">
