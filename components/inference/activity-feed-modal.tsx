...
export function ActivityFeedModal({ open, onOpenChange }: ActivityFeedModalProps) {
  ...
  const handleActivityClick = (activity: InferenceActivity) => {
    ...
    if (activities.length === 0) {
      return (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">Activities from your inference pads will appear here</p>
        </div>
      )
    }
        ...
        <DialogContent className="max-w-3xl max-h-[80vh] p-0">
          <DialogHeader className="px-6 pt-6">
            <div className="flex items-center justify-between">
              <div>
                <DialogTitle className="text-2xl">Inference Activity</DialogTitle>
