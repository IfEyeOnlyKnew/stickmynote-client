...
export function CommandPalette({
  ...
  const actions: CommandAction[] = useMemo(() => {
    const baseActions: CommandAction[] = [
      {
        ...
        onSelect: () => router.push("/inference"),
      ...
      },
      {
        ...
        onSelect: () => router.push("/inference/search"),
        keywords: ["find", "query"],
        group: "Navigation",
      },
      {
        ...
        onSelect: () => router.push("/inference/my-pads"),
        keywords: ["workspaces"],
        group: "Navigation",
      },
      {
        ...
        onSelect: () => router.push("/inference/activity"),
      ...
      },
      {
        ...
        onSelect: () => router.push("/inference/notifications"),
        keywords: ["alerts"],
        group: "Navigation",
      },
      {
        ...
        onSelect: () => router.push("/inference/hubs"),
    ...
    const padActions: CommandAction[] = recentPads.map((pad) => ({
      ...
      label: pad.name,
      icon: <FileText className="mr-2 h-4 w-4" />,
      onSelect: () => router.push(`/inference?pad=${pad.id}`),
