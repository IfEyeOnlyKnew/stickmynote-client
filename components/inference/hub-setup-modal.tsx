...
export function HubSetupModal({ open, onOpenChange, hubType: initialHubType }: HubSetupModalProps) {
  ...
  const handleCreate = async () => {
    ...
    router.push(`/inference/pads/${result.pad.id}/edit`)
    setLoading(false)
  }
  ...
  const renderTypeSelection = () => (
    <>
      <DialogHeader>
        <DialogTitle className="text-2xl">Create Your Inference Hub</DialogTitle>
        <DialogDescription>
          Choose the type of Inference Hub you want to create. You can create both types later.
        </DialogDescription>
      </DialogHeader>
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600">
              Perfect for personal projects, freelancers, or individual content creators. Manage your own inference
